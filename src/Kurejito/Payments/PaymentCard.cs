...
namespace Kurejito.Payments {
    ...
    public class PaymentCard {
        private static readonly IList<IValidate<PaymentCard>> Validators = new List<IValidate<PaymentCard>> {
                                                                                      new RequiredValidator<PaymentCard>(pc => pc.CardHolder, () => Payments.PaymentCard_BlankProperty),
                                                                                      new RequiredValidator<PaymentCard>(pc => pc.CV2, () => Payments.PaymentCard_BlankProperty),
                                                                                      new RequiredValidator<PaymentCard>(pc => pc.ExpiryDate, () => Payments.PaymentCard_BlankProperty),
                                                                                  };
        ...
        public ValidationResult Validate() {
            return ValidationResult.FromRunning(this, Validators);
        }
    }
}