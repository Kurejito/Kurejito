...
namespace Kurejito.Payments {
    ...
    public class PaymentCard {
        private static readonly PaymentCardValidator PaymentCardValidator = new PaymentCardValidator();

        /// <summary>
        ///   Initialize an empty instance of <see cref = "PaymentCard" />
        /// </summary>
        public PaymentCard() {}
        ...
        /// <summary>
        ///   The card holder's name, as it appears on the payment card.
        /// </summary>
        public string CardHolder { get; set; }

        /// <summary>
        ///   The PAN, or Personal Account Number - normally the long number across the front of the payment card.
        /// </summary>
        public string CardNumber { get; set; }

        /// <summary>
        ///   The card start date, where available
        /// </summary>
        ...
        /// <summary>
        ///   The card issue number, found on somee Maestro and Solo cards.
        /// </summary>
        public int? IssueNumber { get; set; }

        /// <summary>
        ///   The card verification value, normally the extra three digits on the card signature strip.
        /// </summary>
        ...
        public bool HasStartDate {
            get { return (this.StartDate != null && this.StartDate.HasValue); }
        }
        ...
        public bool HasIssueNumber {
            get { return (this.IssueNumber.HasValue); }
        }
        ...
        public ValidationResult Validate() {
            return PaymentCardValidator.Validate(this);
        }
    }
}